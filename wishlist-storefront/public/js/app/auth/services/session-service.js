...
angular.module('ds.auth')
    ...
    .factory('SessionSvc', ['AccountSvc', 'CartSvc', 'GlobalData', '$state', '$stateParams', 'settings', '$rootScope', '$q','WishlistSvc',
        function (AccountSvc, CartSvc, GlobalData, $state, $stateParams, settings, $rootScope, $q, WishlistSvc) {
            ...
            function commonPostLogin(context){
                ...
                CartSvc.refreshCartAfterLogin(GlobalData.customerAccount.id).then(
                    function () {
                        WishlistSvc.refreshWishlistAfterLogin(GlobalData.customerAccount.id).then(
                            function () {
                                deferred.resolve();
                            },
                            function () {
