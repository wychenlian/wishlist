...
/** Handles interactions with the top menu (mobile menu, mobile search, mobile cart & full screen cart icon) */
    .controller('TopNavigationCtrl', ['$scope', '$rootScope', '$state', '$controller', '$timeout', 'GlobalData', 'CartSvc', 'AuthSvc', 'AuthDialogManager', 'CategorySvc', 'settings', 'YGoogleSignin','WishlistSvc',

        function ($scope, $rootScope, $state, $controller, $timeout, GlobalData, CartSvc, AuthSvc, AuthDialogManager, CategorySvc, settings, YGoogleSignin,WishlistSvc) {
            ...
            $scope.wishlistId =  WishlistSvc.getLocalWishlistId();
            var wishlistUnbind = $rootScope.$on('wishlist:updated', function (eve, eveObj) {
            ...
            $scope.$on('$destroy', wishlistUnbind);
