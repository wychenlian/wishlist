...
var ProductDetailsPageObject = function () {
    ...
    var wishlistButtons = {
        addToWishlist: element(by.id('wishlist-buy-button'))
    };
    ...
    this.addProductToWishlist = function (quantity) {
        wishlistInputFields.quantity.clear();
        wishlistInputFields.quantity.sendKeys(quantity);
        wishlistButtons.addToWishlist.click();
    };
};
